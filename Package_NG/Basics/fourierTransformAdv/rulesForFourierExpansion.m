...
rulesForFourierExpansion[quantityName_, quantityNameFourierTransformed_] := Module[{result, k1Pup, k2Pup, k3Pup},
	k1Pup = Unique[k1];
	k2Pup = Unique[k2];
	k3Pup = Unique[k3];
	result = {Derivative[d1_, d2_, d3_, d4_][quantityName][x,y,z,t] :> Integrate[Exp[I (k1Pup x+k2Pup y+k3Pup z)]*(I k1Pup)^d1*(I k2Pup)^d2*(I k3Pup)^d3*D[quantityNameFourierTransformed[k1Pup,k2Pup,k3Pup,t], {t, d4}],
																				{k1Pup, -Infinity, +Infinity}, {k2Pup, -Infinity, +Infinity}, {k3Pup, -Infinity, +Infinity}],
				quantityName[x,y,z,t] :> Integrate[Exp[I (k1Pup x+k2Pup y+k3Pup z)]*quantityNameFourierTransformed[k1Pup,k2Pup,k3Pup,t],
													{k1Pup, -Infinity, +Infinity}, {k2Pup, -Infinity, +Infinity}, {k3Pup, -Infinity, +Infinity}]};
	Return@result;];
